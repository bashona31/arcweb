      ...
      <div className="relative z-10 p-6">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-lg" style={{ background: "rgba(190,242,100,0.1)", border: "1px solid rgba(190,242,100,0.15)", boxShadow: "0 0 12px rgba(190,242,100,0.15)" }}>
        ...
        {!isConnected ? (
          <div className="text-center py-10">
            <div className="inline-flex p-5 rounded-full mb-4" style={{ background: "rgba(190,242,100,0.05)", border: "1px solid rgba(190,242,100,0.1)", boxShadow: "0 0 40px rgba(190,242,100,0.08)" }}>
          ...
          <div className="space-y-5">
            ...
            <div className="relative flex justify-center py-8">
              ...
              <motion.div
                ...
                style={{ background: "radial-gradient(circle, rgba(190,242,100,0.12) 0%, transparent 70%)" }}
              />
              ...
              >
                ...
                <motion.div
                  ...
                  style={{ border: "1px dashed rgba(190,242,100,0.2)" }}
                />
            ...
            {cooldown > 0 && (
              <motion.div
                ...
                style={{ background: "rgba(190,242,100,0.06)", border: "1px solid rgba(190,242,100,0.15)" }}
              >

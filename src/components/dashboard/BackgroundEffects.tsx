  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(190,242,100,0.08) 0%, transparent 70%)" }}
      />
      ...
      {[...Array(10)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 0 6px rgba(163,230,53,0.4)",
          }}
        />
      ))}
      {/* Top edge light */}
      <div className="absolute top-0 left-0 right-0 h-px" style={{
        background: "linear-gradient(90deg, transparent 0%, rgba(163,230,53,0.25) 50%, transparent 100%)",
      }} />
      {/* Noise */}
